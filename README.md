...
| <a name="input_enabled_interconnect_attachment"></a> [enabled\_interconnect\_attachment](#input\_enabled\_interconnect\_attachment) | Set to true to enable interconnect attachment, false otherwise. | `bool` | `false` | no |
...
| <a name="input_peer_asn"></a> [peer\_asn](#input\_peer\_asn) | The ASN (Autonomous System Number) of the peer for the interconnect. | `number` | `65513` | no |
